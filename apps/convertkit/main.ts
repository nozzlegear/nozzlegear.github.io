...
namespace ConvertKit
{
    ...
    {
        export var SecretKeyId = "ConvertKit-Secret-Key";
    }
    ...
    export class Main
    {
        ...
        */
        static State: {
            SettingsController?: ConvertKit.SettingsController;
            HomeController?: ConvertKit.HomeController;
            FormsController?: ConvertKit.FormsController;
        } = {};
        ...
        static Start = () =>
        {
            ...
            app.onactivated = function(args)
            {
                ...
                if (args.detail.kind === "Windows.Launch")
                {
                    ...
                    //Begin processing UI.
                    var appPromise = WinJS.UI.processAll().then(null, (error) =>
                    {
                    ...
                    appPromise = appPromise
                        .then(() =>
                        {
                            ...
                            {                                
                                ...
                                return WinJS.Navigation.navigate(Main.CurrentPage() ? ConvertKit[Main.CurrentPage()].PageUrl : HomeController.PageUrl, WinJS.Navigation.state);
                            }
                    ...
                    appPromise.done(() =>
                    {
                        var updateReady = () =>
                        {
                            //Swap the cache. Page must be reloaded for changes to take effect.
                            window.applicationCache.swapCache()

                            Utils.ShowDialog("Update available.", "An update has been installed for ConvertKit. Tap 'Activate' below to switch to the new version.", "Activate", (event) =>
                            {
                        ...
                        //Manually start testing for a new manifest file
        ...
        */
        ...
        {
            if (Main.CurrentPage() !== HomeController.PageId)
            {
                WinJS.Navigation.navigate(HomeController.PageUrl, eventOrState);
        ...
        /**
        Navigates the user to the forms page.
        */
        static HandleNavigateToForms = (context, event) =>
        {
            if (Main.CurrentPage() !== FormsController.PageId)
            {
                WinJS.Navigation.navigate(FormsController.PageUrl);
