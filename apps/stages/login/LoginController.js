        ...
        var LoginController = (function () {
            function LoginController() {
                ...
                this.HandleLoginEvent = function (context, event) {
                    if (!_this.SecretKey()) {
                        App.Utils.ShowDialog("Error", "You must enter a valid API key or access token to continue.");
                        return;
                    }
                    ...
                    var success = function (subs) {
                        App.Utils.LocalStorage.Save("X-Stages-API-Key", _this.SecretKey());
                        var state = {
                            Accounts: subs
                        };
                    ...
                    var fail = function (reason) {
                        ...
                        App.Utils.ShowDialog("Error", "It looks like your secret key or access token is invalid. Please try again.");
